  ...
  for {set dn 0} {$dn < $num_domains} {incr dn} {
      ...
      set dom_cen [lindex $domains_cen $dn]
      puts "\n\n*** Rotation quantification for $domain_name:\n"

      set rotaxislblcol $axislblcol
      set rotaxiscol "green"
      ShowDomainAxisAngleQuat $nFiles $allmodel $domain_name $molid_model_full $dom_cen $rotaxiscol $rotaxislblcol $QuatRotAxisFile $QuatEulerAnglesFile
  }
  ...
  ## fist calculated using the Orient script, we may not be able to fix the direction 
