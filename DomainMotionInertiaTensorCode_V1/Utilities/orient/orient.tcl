...
proc vmd_draw_principalaxes { mol sel axiscol axislblcol adjustdirection adjustscale {weights domass} } {
    ...
    graphics $mol text [vecadd $COM [vecscale $scale2 $a1]] "1" size 1 thickness 3
    graphics $mol text [vecadd $COM [vecscale $scale2 $a2]] "2" size 1 thickness 3
    graphics $mol text [vecadd $COM [vecscale $scale2 $a3]] "3" size 1 thickness 3
